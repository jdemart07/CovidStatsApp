        ...
        AF.request("https://covid-19-data.p.rapidapi.com/country/all?format=undefined", headers: headers).responseJSON { response in
            ...
            if result != nil {
                ...
                for countryData in dataDictionary {
                    ...
                    let countryObject = CountryData(country: country, confirmed: Int(confirmed), critical: Int(critical), deaths: Int(deaths), recovered: Int(recovered), longitude: longitude, latitude: latitude)
